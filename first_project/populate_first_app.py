...
# Need to do this before we start manipulating the actual models (in terminal, try directly importing models. you'll see why we use the below code)
import os
...
def add_topic():
    ...
    """
    print("-----Entering the creation of Topic")
    t = Topic.objects.get_or_create(top_name=random.choice(topics))[0]
    print("-----Done with creating Topic")
    t.save()
    return t
...
def populate(N=5):
    ...
    for entry in range(N):
        ...
        print("-----Entering the Realm of Fakeness!!!")
